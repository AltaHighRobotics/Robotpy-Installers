...
def DefaultFunc():
    ...
    runpy([sys.executable, '-m', 'pip', 'install', 'robotpy==2024.3.2.2'])  #Installs the working version of robotpy that includes phoenix5 dep, because the latest version of robotpy DOES NOT include phoenix5
